...
<head>
    <meta charset="UTF-8">
    <title>TimeTracking - Add Activity</title>
...
<body>
    ...
    <br />
    <h2 class="text-center">Add Activity</h2><br />

    <div class="container">
        <form name="update" action="${pageContext.request.contextPath}/activity/add" method="post">
